...
//	$subjectid = $subjrow['subjectid'];
	...
	if(!empty($commentrow['teachers'])){
		...
		".$semesters[($semester)]." Progress Report: ".$subj_name."<br />
...
$pdf_key = "<div id='header' ><div id='text'><strong><font size='+1'>Wildwood Elementary School<br />
		...
		" .$sturow['fname']." ".$sturow['lname']. " - " . $printgrade ."</font></strong></div></div>
		<span style='font-size: 12px'><br /><br /><b>Teachers: </b>".$allteachers."<br /><br /><b>Evaluation Rubric:</b><br />
		";
...
while($assessrow = mysql_fetch_array($assessresult)){
	...
	$key_rows .= "<tr valign='middle'>".$key_col."<td><b>". $assessrow['assess_name']." (".$assessrow['assess_abbr']."): </b> Means ".$sturow['fname']." ".$assessrow['assess_descrip']."</td></tr>
	";
...
$pdf_key .=	"</table><br><br>".$messages[$skillgrade]."</span>
