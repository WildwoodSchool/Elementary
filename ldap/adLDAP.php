...
class adLDAP {
    ...
    * @var string
    */   
	protected $_account_suffix = "@wildwood.org";
    ...
    * @var string
    */
	protected $_base_dn = "dc=wildwood,dc=org"; 
    ...
    * @var array
    */
    protected $_domain_controllers = array ("ww2dc01.wildwood.org");
    ...
    * @var string
    */
	protected $_ad_username="webattendance";
    protected $_ad_password="B@yC!t!es";
